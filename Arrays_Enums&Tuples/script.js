...
const arr = [1, 101, 10101, 1010101]; //unlike JS,if we defined the data type of array,we cannot pass ant other datatype into an array!
const rating = [1.2, 5, 9, 8, 6]; //another way of defining array
const CoffeTypes = [{ type: "Plain", price: 20, sugarLevel: "low" }, { type: "Cappuccino", price: 40, sugarLevel: "med" }];
//ReadOnly arrays->Once defined,can't be modified!
const Citeies = ["Delhi", "Boston", "Madrid", "Manchester", "Milan"];
// cities.push("Birmingham"),cant do that!!
const grid = [[1, 36, 62, 222677, 7], [7, 8, 1, 3]]; //2D array
let coffeeTuple;
coffeeTuple = ["Plain", 20];
console.log(coffeeTuple);
const coordinates = [1083.611, -9862.43, 112.42]; //READ ONLY TUPLE
const pizza = ["CheeseBurst", 200, false]; //namd tuples!
var CupSize;
(function (CupSize) {
